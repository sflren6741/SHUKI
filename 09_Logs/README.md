...
**JP** — 日付つきの記録：スタンドアップ・週次レビュー・内省・MTGメモ・分析。「Log か Resource か」の判断は **「日付の固有性で意味が決まるか？」**。Yes → Log（その日のスナップショット、再現性なし）。No → Resource（再利用ナレッジ、日付は付随）。重要なログには `## 気づき` を足して概念ノードへリンクし、グラフを編む。

> Template: `_Templates/ログ.md`. Skeleton: `ログ/_example-log.md`.
